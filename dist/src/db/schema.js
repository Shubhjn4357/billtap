...
export const salaryRunItems = pgTable('salary_run_items', {
    ...
    componentBreakdown: jsonb('componentBreakdown').$type().default([]).notNull(),
    payslipData: jsonb('payslipData').$type(),
    createdAt: timestamp('createdAt', { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: timestamp('updatedAt', { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
}, (table) => ({
...
export const gstNotes = pgTable('gst_notes', {
    ...
    items: jsonb('items').$type().default([]).notNull(),
    createdAt: timestamp('createdAt', { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: timestamp('updatedAt', { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
}, (table) => ({
...
export const billTemplates = pgTable('bill_templates', {
    ...
    isActive: boolean('isActive').default(true).notNull(),
    layoutConfig: jsonb('layoutConfig').$type().default({}).notNull(),
    createdAt: timestamp('createdAt', { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: timestamp('updatedAt', { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
}, (table) => ({
