      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .watermark-overlay { text-align: center; font-size: 9px; color: #9ca3af; margin-top: 8px; font-weight: 700; border-top: 1px dotted #e5e7eb; padding-top: 4px; }
        </style>
      </head>
      <body>
        <div class="receipt">
          ...
          <div class="watermark-overlay">⚡ Generated by Vahi</div>
        </div>
      </body>
    </html>
    `;
