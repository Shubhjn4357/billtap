...
const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  { group: 'Users', method: 'PATCH', path: '/api/users/me', access: 'Bearer Token', description: 'Update current user.', sampleBody: { businessName: 'Vahi Mart', gstEnabled: true } },
    ...
    { group: 'GST Compliance', method: 'GET', path: '/api/gst-compliance/summary?start=&end=', access: 'Bearer Token', description: 'GST summary with B2B/B2C and ITC rollups.' },
    { group: 'GST Compliance', method: 'GET', path: '/api/gst-compliance/classification?start=&end=&type=&limit=', access: 'Bearer Token', description: 'Invoice classification with place-of-supply logic.' },
    { group: 'GST Compliance', method: 'GET', path: '/api/gst-compliance/itc-register?start=&end=&limit=', access: 'Bearer Token', description: 'Input Tax Credit register and mismatch indicators.' },
    { group: 'GST Compliance', method: 'GET', path: '/api/gst-compliance/export/gstr1?start=&end=&format=', access: 'Bearer Token', description: 'Export GSTR-1 in JSON/CSV.' },
    { group: 'GST Compliance', method: 'GET', path: '/api/gst-compliance/export/gstr3b?start=&end=&format=', access: 'Bearer Token', description: 'Export GSTR-3B in JSON/CSV.' },
    { group: 'GST Compliance', method: 'GET', path: '/api/gst-compliance/notes?type=&status=&limit=', access: 'Bearer Token', description: 'List credit/debit GST notes.' },
    { group: 'GST Compliance', method: 'POST', path: '/api/gst-compliance/notes', access: 'Bearer Token', description: 'Create credit/debit GST note.' },
    { group: 'GST Compliance', method: 'POST', path: '/api/gst-compliance/notes/{id}/apply', access: 'Bearer Token', description: 'Apply GST note.' },
    { group: 'GST Compliance', method: 'POST', path: '/api/gst-compliance/notes/{id}/cancel', access: 'Bearer Token', description: 'Cancel GST note.' },
    ...
    { group: 'Enterprise', method: 'GET', path: '/api/enterprise/branches', access: 'Bearer Token', description: 'List branches.' },
    { group: 'Enterprise', method: 'POST', path: '/api/enterprise/branches', access: 'Bearer Token', description: 'Create branch.' },
    { group: 'Enterprise', method: 'PATCH', path: '/api/enterprise/branches/{id}', access: 'Bearer Token', description: 'Patch branch.' },
    { group: 'Enterprise', method: 'GET', path: '/api/enterprise/cost-centers', access: 'Bearer Token', description: 'List cost centers.' },
    { group: 'Enterprise', method: 'POST', path: '/api/enterprise/cost-centers', access: 'Bearer Token', description: 'Create cost center.' },
    { group: 'Enterprise', method: 'PATCH', path: '/api/enterprise/cost-centers/{id}', access: 'Bearer Token', description: 'Patch cost center.' },
    { group: 'Enterprise', method: 'GET', path: '/api/enterprise/projects', access: 'Bearer Token', description: 'List projects.' },
    { group: 'Enterprise', method: 'POST', path: '/api/enterprise/projects', access: 'Bearer Token', description: 'Create project.' },
    { group: 'Enterprise', method: 'PATCH', path: '/api/enterprise/projects/{id}', access: 'Bearer Token', description: 'Patch project.' },
    { group: 'Enterprise', method: 'GET', path: '/api/enterprise/branch-transfers?limit=', access: 'Bearer Token', description: 'List branch transfers.' },
    { group: 'Enterprise', method: 'POST', path: '/api/enterprise/branch-transfers', access: 'Bearer Token', description: 'Create inter-branch stock transfer.' },
    { group: 'Enterprise', method: 'GET', path: '/api/enterprise/reports/consolidated?start=&end=', access: 'Bearer Token', description: 'Consolidated branch-wise performance report.' },
    { group: 'Enterprise', method: 'GET', path: '/api/enterprise/reports/branches/{id}?start=&end=', access: 'Bearer Token', description: 'Single branch books summary.' },
    ...
    { group: 'Institution', method: 'GET', path: '/api/institution/students?organizationId=&activeOnly=', access: 'Bearer Token', description: 'List institution students.' },
    { group: 'Institution', method: 'POST', path: '/api/institution/students?organizationId=', access: 'Bearer Token', description: 'Create institution student.' },
    { group: 'Institution', method: 'GET', path: '/api/institution/fee-invoices?organizationId=&studentId=&status=&dueBefore=&limit=', access: 'Bearer Token', description: 'List fee invoices.' },
    { group: 'Institution', method: 'POST', path: '/api/institution/fee-invoices?organizationId=', access: 'Bearer Token', description: 'Create fee invoice with barcode.' },
    { group: 'Institution', method: 'POST', path: '/api/institution/fee-invoices/{id}/collect?organizationId=', access: 'Bearer Token', description: 'Collect fee payment online/offline.' },
    { group: 'Institution', method: 'GET', path: '/api/institution/fee-reminders/due?organizationId=&dueBefore=', access: 'Bearer Token', description: 'Due fee reminders list.' },
    { group: 'Institution', method: 'POST', path: '/api/institution/fee-reminders/{invoiceId}/send-whatsapp?organizationId=', access: 'Bearer Token', description: 'Send WhatsApp fee reminder.' },

    { group: 'Communications', method: 'GET', path: '/api/communications/messages/logs?organizationId=&channel=&status=&limit=', access: 'Bearer Token', description: 'Message logs (WhatsApp/SMS/Email).' },
    { group: 'Communications', method: 'POST', path: '/api/communications/messages/send?organizationId=', access: 'Bearer Token', description: 'Send custom message with optional barcode/media.' },
