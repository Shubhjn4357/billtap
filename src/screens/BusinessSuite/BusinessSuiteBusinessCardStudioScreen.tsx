        ...
        <ScreenWrapper>
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <AppCard animationDelay={80}>
                    ...
                    <AppInput label="Owner Name" value={ownerName} onChangeText={setOwnerName} placeholder="Owner" />
                    <AppInput label="Phone Number" value={phoneNumber} onChangeText={setPhoneNumber} placeholder="+91..." />
                    <AppInput label="Email" value={email} onChangeText={setEmail} placeholder="name@business.com" />
                    <AppInput label="Website" value={website} onChangeText={setWebsite} placeholder="https://..." />
                    <AppInput label="Tagline" value={tagline} onChangeText={setTagline} placeholder="Quality first" />
                    <AppInput label="Address" value={address} onChangeText={setAddress} placeholder="Store address" />
                    <AppInput label="GST Number" value={gstNumber} onChangeText={setGstNumber} placeholder="GSTIN" />
                    <AppInput
