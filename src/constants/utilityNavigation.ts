...
export const MORE_SCREEN_SECTIONS: UtilityScreenSection[] = [
    {
        title: 'Workspace',
        items: [
            { label: 'Settings Hub', route: '/(main)/settings', description: 'Business setup, taxes, inventory rules, and app preferences.', icon: 'cog-outline', module: 'settings' },
            { label: 'Subscription', route: '/(main)/settings/subscription', description: 'Plan, limits, renewals, and current status.', icon: 'crown-outline', tone: 'info' },
    ...
    },
    {
        ...
        items: [
            { label: 'Operations', route: '/(main)/settings/operations', description: 'Lock periods, approvals, and process controls.', icon: 'cog-transfer-outline', module: 'operations' },
            { label: 'Announcements', route: '/(main)/settings/announcements', description: 'Offers and product notices from the system.', icon: 'bullhorn-outline', module: 'operations', tone: 'info' },
            { label: 'Offline Sync Diagnostics', route: '/(main)/settings/sync', description: 'Queue health, retry state, and blocked sync items.', icon: 'cloud-sync-outline', tone: 'warning' },
        ],
    },
    {
        title: 'Business',
        items: [
            { label: 'Printing & Templates', route: '/(main)/settings/printing', description: 'Thermal, PDF layouts and business card preview.', icon: 'printer-outline', module: 'settings' },
            { label: 'Staff and Roles', route: '/(main)/settings/staff', description: 'Invite staff and manage role access.', icon: 'account-group-outline', module: 'staff' },
            { label: 'Role Access', route: '/(main)/settings/role-access', description: 'Fine-grained module permissions.', icon: 'shield-account-outline', module: 'settings', ownerOnly: true },
...
export const SCREEN_DIRECTORY_SECTIONS: UtilityScreenSection[] = [
    {
        ...
        items: [
            ...
            { label: 'Settings', route: '/(main)/settings', description: 'Settings and system modules' },
        ],
    },
    {
        title: 'Billing Flows',
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Item Masters', route: '/(main)/settings/item-masters', description: 'Categories and units', module: 'inventory' },
            { label: 'Godowns', route: '/(main)/settings/godowns', description: 'Warehouse and stock transfer', module: 'inventory', requiresFeature: FeatureFlag.MULTI_GODOWN },
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Profit and Loss', route: '/(main)/settings/reports/pnl', description: 'Income vs expense report', module: 'reports' },
            { label: 'GSTR-1', route: '/(main)/settings/reports/gstr1', description: 'Outward supplies', module: 'reports' },
            { label: 'GSTR-3B', route: '/(main)/settings/reports/gstr3b', description: 'Monthly GST summary', module: 'reports' },
        ],
    },
    {
        title: 'Control and Settings',
        items: [
            { label: 'Settings', route: '/(main)/settings', description: 'All settings sections', module: 'settings' },
            { label: 'Staff', route: '/(main)/settings/staff', description: 'Invite/manage team', module: 'staff' },
            { label: 'Role Access', route: '/(main)/settings/role-access', description: 'Role/module/action permissions', module: 'settings', ownerOnly: true },
            { label: 'Operations', route: '/(main)/settings/operations', description: 'Utility tools', module: 'operations' },
            { label: 'Announcements', route: '/(main)/settings/announcements', description: 'Business notifications', module: 'operations' },
            { label: 'Sync Diagnostics', route: '/(main)/settings/sync', description: 'Offline sync queue and status' },
            { label: 'Printing & Templates', route: '/(main)/settings/printing', description: 'Thermal and PDF print profiles', module: 'settings' },
            { label: 'App Preferences', route: '/(main)/settings/appearance', description: 'Theme, haptics, and device preferences', module: 'settings' },
            { label: 'Subscription', route: '/(main)/settings/subscription', description: 'Plan and limits' },
        ],
    },
    {
        title: 'Legal',
