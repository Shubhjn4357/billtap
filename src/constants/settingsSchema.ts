...
export const SETTINGS_SCHEMA: Record<SettingsSection, SettingsFieldDefinition[]> = {
    GENERAL: [
        ...
        { key: 'sync_conflict_policy', label: 'Sync Conflict Policy', type: 'enum', enumValues: ['LAST_WRITE_WINS', 'SERVER_WINS'], default: 'LAST_WRITE_WINS' },
        { key: 'sync_auto_interval_sec', label: 'Sync Auto Interval (sec)', type: 'integer', default: 60, min: 15, max: 3600 },
        { key: 'multi_currency_enabled', label: 'Enable Multi Currency', type: 'boolean', default: false },
        { key: 'secondary_currency', label: 'Secondary Currency', type: 'string', nullable: true },
        { key: 'secondary_exchange_rate', label: 'Secondary Exchange Rate', type: 'number', default: 1, min: 0 },
    ],
    SECURITY: [
    ...
    PAYMENT_REMINDERS: [
        ...
        { key: 'party_payment_sms_template', label: 'Party Reminder SMS Template', type: 'string' },
        { key: 'party_payment_whatsapp_template', label: 'Party Reminder WhatsApp Template', type: 'string' },
        { key: 'reminder_auto_schedule_enabled', label: 'Reminder Auto Scheduler', type: 'boolean', default: false },
        { key: 'reminder_schedule_hour', label: 'Reminder Scheduler Hour', type: 'integer', default: 10, min: 0, max: 23 },
        { key: 'reminder_delivery_channel', label: 'Reminder Delivery Channel', type: 'enum', enumValues: ['SMS', 'WHATSAPP', 'SMS_AND_WHATSAPP', 'NONE'], default: 'SMS' },
    ],
    TRANSACTION_SMS: [
        ...
        { key: 'send_whatsapp_to_party', label: 'Send WhatsApp to Party', type: 'boolean', default: false },
        { key: 'send_whatsapp_copy_to_self', label: 'Send WhatsApp Copy to Self', type: 'boolean', default: false },
        ...
        {
            key: 'auto_whatsapp_transactions',
            label: 'Auto WhatsApp Transaction Types',
            type: 'array_of_VoucherType',
            default: ['SALES_INVOICE', 'PAYMENT_IN'],
            enumValues: [...VOUCHER_TYPES],
        },
    ],
    TRANSACTION_HEADER: [
    ...
    INVOICE_PRINT: [
        ...
        { key: 'print_signature_image', label: 'Print Signature Image', type: 'boolean', default: true },
        { key: 'thermal_profile_preset', label: 'Thermal Profile Preset', type: 'enum', enumValues: ['58MM_COMPACT', '80MM_STANDARD', 'A4_CLASSIC'], default: 'A4_CLASSIC' },
        { key: 'printer_connection_type', label: 'Printer Connection Type', type: 'enum', enumValues: ['USB', 'BLUETOOTH', 'WIFI'], default: 'USB' },
        { key: 'printer_pairing_name', label: 'Printer Pairing Name', type: 'string', nullable: true },
