...
export const SIDE_DRAWER_ACTIONS: NavigationShortcut[] = [
    ...
    { key: 'journal-entry', label: 'Journal Entry', route: '/(main)/accounts/journal', icon: 'book-plus-multiple-outline', module: 'accounts' },
    { key: 'expenses', label: 'Expenses', route: '/(main)/accounts/expenses', icon: 'cash-minus', module: 'accounts' },
    { key: 'reports', label: 'Reports', route: '/(main)/reports', icon: 'chart-line', module: 'reports' },
...
export const GO_TO_PALETTE_ROUTES: NavigationShortcut[] = [
    ...
    { key: 'journal-entry', label: 'Journal Entry', route: '/(main)/accounts/journal', description: 'Manual voucher entries', module: 'accounts', icon: 'book-plus-multiple-outline' },
    ...
    { key: 'brs', label: 'Bank Reconciliation', route: '/(main)/reports/brs', description: 'Match CSV statements', module: 'reports', icon: 'bank-check' },
    { key: 'import-journal', label: 'Import Journals', route: '/(main)/settings/import-journal', description: 'Bulk CSV import', module: 'accounts', icon: 'file-import-outline' },
    { key: 'close-period', label: 'Close Period', route: '/(main)/settings/close-period', description: 'Year-end accounting', module: 'accounts', icon: 'calendar-check' },
