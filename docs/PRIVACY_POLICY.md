...
- Operational metadata: device and platform details and usage diagnostics.
...
- You should protect device access with passcode or biometric security where possible.

## 5. Retention and Deletion

- Data is retained while your account is active and as needed for legal and compliance obligations.
